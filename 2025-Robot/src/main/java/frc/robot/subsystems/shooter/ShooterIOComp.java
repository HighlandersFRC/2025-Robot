...
public class ShooterIOComp implements ShooterIO {
        ...
        public void init() {
                ...
                shooterMotorConfiguration.Slot0.kP = 120.0;
        ...
        public void setShooterRPM(double rpm) {
                ...
                shooterMotorFollower.setControl(flywheelVelocityRequest
                                .withVelocity(Constants.RPMToRPS(rpm) * Constants.Ratios.Shooter.SHOOTER_GEAR_RATIO));
                System.out.println("rpm: " + shooterMotorMaster.getClosedLoopError().getValueAsDouble()
                                + ". torque current: " + shooterMotorMaster.getTorqueCurrent());
