...
public final class Constants {
    ...
    public static class Reef {
        ...
        public static final Pose2d RED_RIGHT_FEEDER = new Pose2d(
                RED_LEFT_FEEDER_X, Physical.FIELD_WIDTH - RED_LEFT_FEEDER_Y, new Rotation2d(Math.toRadians(234.0)));

        public static final Pose2d BLUE_RIGHT_FEEDER = new Pose2d(
                Physical.FIELD_LENGTH - RED_LEFT_FEEDER_X, RED_LEFT_FEEDER_Y, new Rotation2d(Math.toRadians(54.0)));
            ...
            for (int face = 0; face < 6; face++) {
                ...
                algaeFrontMore = new Pose2d(
                        new Translation2d(
                                poseDirection
                                        .transformBy(
                                                new Transform2d(adjustAlgaeMoreX, adjustAlgaeMoreY, new Rotation2d()))
                                        .transformBy(
                                                new Transform2d(Physical.INTAKE_X_OFFSET_FRONT_ALGAE,
                                                        Physical.INTAKE_Y_OFFSET_FRONT_ALGAE,
                                                        new Rotation2d(Math.PI)))
                ...
                l4BackRight = new Pose2d(
                        new Translation2d(
                                poseDirection
                                        .transformBy(new Transform2d(adjustX, adjustY, new Rotation2d()))
                                        .transformBy(new Transform2d(Physical.L4_INTAKE_X_OFFSET_BACK,
                ...
                l3BackRight = new Pose2d(
                        new Translation2d(
                                poseDirection
                                        .transformBy(new Transform2d(adjustX, adjustY, new Rotation2d()))
                                        .transformBy(new Transform2d(Physical.L3_INTAKE_X_OFFSET_BACK,
    ...
    public static final class Physical {
        ...
        public static final double INTAKE_X_OFFSET_FRONT = inchesToMeters(25);
        // public static final double INTAKE_X_OFFSET_FRONT = inchesToMeters(24.5);
        public static final double INTAKE_Y_OFFSET_FRONT = inchesToMeters(3.25);
        public static final double INTAKE_X_OFFSET_BACK = inchesToMeters(26);
        // public static final double INTAKE_X_OFFSET_BACK = inchesToMeters(25.5);
        public static final double INTAKE_Y_OFFSET_BACK = inchesToMeters(-3.25);
    ...
    public static final class SetPoints {
        ...
        public static final double ELEVATOR_L4_POSITION_M = inchesToMeters(66.0);
    ...
    public static final class Vision {
        ...
        public static final double[][] TAG_POSES = {
                { inchesToMeters(657.37), inchesToMeters(25.8), inchesToMeters(58.5), Math.toRadians(126),
                        Math.toRadians(0) },
                { inchesToMeters(657.37), inchesToMeters(291.2), inchesToMeters(58.5), Math.toRadians(234),
                        Math.toRadians(0) },
                { inchesToMeters(455.15), inchesToMeters(317.15), inchesToMeters(51.25), Math.toRadians(270),
                        Math.toRadians(0) },
                { inchesToMeters(365.2), inchesToMeters(241.64), inchesToMeters(73.54), Math.toRadians(0),
                        Math.toRadians(30) },
                { inchesToMeters(365.2), inchesToMeters(75.39), inchesToMeters(73.54), Math.toRadians(0),
                        Math.toRadians(30) },
                { inchesToMeters(530.49), inchesToMeters(130.17), inchesToMeters(12.13), Math.toRadians(300),
                        Math.toRadians(0) },
                { inchesToMeters(546.87), inchesToMeters(158.5), inchesToMeters(12.13), Math.toRadians(0),
                        Math.toRadians(0) },
                ...
                { inchesToMeters(33.51), inchesToMeters(25.8), inchesToMeters(58.5), Math.toRadians(54),
                        Math.toRadians(0) },
                { inchesToMeters(33.51), inchesToMeters(291.2), inchesToMeters(58.5), Math.toRadians(306),
                        Math.toRadians(0) },
                ...
                { inchesToMeters(325.68), inchesToMeters(75.39), inchesToMeters(73.54), Math.toRadians(180),
                        Math.toRadians(30) },
                { inchesToMeters(235.73), inchesToMeters(-0.15), inchesToMeters(51.25), Math.toRadians(90),
                        Math.toRadians(0) },
                { inchesToMeters(160.39), inchesToMeters(130.17), inchesToMeters(12.13), Math.toRadians(240),
                        Math.toRadians(0) },
                { inchesToMeters(144), inchesToMeters(158.5), inchesToMeters(12.13), Math.toRadians(180),
                        Math.toRadians(0) },
                { inchesToMeters(160.39), inchesToMeters(186.83), inchesToMeters(12.13), Math.toRadians(120),
                        Math.toRadians(0) },
                { inchesToMeters(193.1), inchesToMeters(186.83), inchesToMeters(12.13), Math.toRadians(60),
                        Math.toRadians(0) },
                { inchesToMeters(209.49), inchesToMeters(158.5), inchesToMeters(12.13), Math.toRadians(0),
                        Math.toRadians(0) },
                { inchesToMeters(193.1), inchesToMeters(130.17), inchesToMeters(12.13), Math.toRadians(300),
                        Math.toRadians(0) }
        };

        public static final double[][] redSideReefTags = {
                TAG_POSES[6 - 1], TAG_POSES[7 - 1], TAG_POSES[8 - 1], TAG_POSES[9 - 1], TAG_POSES[10 - 1],
                TAG_POSES[11 - 1] };
